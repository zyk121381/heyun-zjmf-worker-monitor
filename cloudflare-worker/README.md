...
1. Fork 本仓库。
2. [点击下载：步骤1-一键安装脚本](https://github.com/loqwe/heyun-zjmf-worker-monitor/releases/download/release-step1-bat-v1/step1-install.bat)，保存到你想部署的目录。
   这是 Release 附件下载链接，点击后会下载 `step1-install.bat`。
3. 准备 Cloudflare Token、Account ID、Fork 后的仓库地址和魔方财务 API。
4. 双击下载得到的 `step1-install.bat`，按提示填写信息。
