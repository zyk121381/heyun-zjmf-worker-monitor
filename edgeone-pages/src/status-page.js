...
<body>
  <main>
    ...
    <section class="hero">
      <span class="tag">Revelation Monitor</span> · <span class="tag">${escapeHtml(COMMIT)}</span>
    ...
    <footer>
      ...
      <div class="footer-sponsors"><p style="display: inline-flex; align-items: center; margin: 0"><a href="https://www.heyunidc.cn/aff/GXMRNREQ" target="_blank" title="核云"><img src="https://www.heyunidc.cn/themes/web/www/upload/local68c30272ab53b.png" alt="核云" height="17" style="margin: 0 3px;"></a> | <a href="https://www.cloudflare-cn.com/" target="_blank" title="Cloudflare"><img src="https://cf-assets.cloudflare-cn.com/dzlvafdwdttg/69wNwfiY5mFmgpd9eQFW6j/d5131c08085a977aa70f19e7aada3fa9/1pixel-down__1_.svg" alt="Cloudflare" height="20" style="margin: 0 3px;"></a> | <a href="https://sub.anzhiyu.com/register?aff=WTHZW3CRG4WP" target="_blank" title="鱼鱼API——超好用超便宜的GPT、Claude中转站！"><img src="https://anheyu.com/logo.svg" alt="鱼鱼API——超好用超便宜的GPT、Claude中转站！" height="17" style="margin: 0 3px;">鱼鱼API</a></p></div>
